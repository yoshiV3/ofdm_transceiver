...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1_1.set_update_time(1)
        ...
        self.blocks_file_source_0_1_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/mnt/c/Users/yoshi/Documents/school/master1.2/PandD/ofdm/python_files/received.dat', True)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0_1_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_file_source_0_1_1, 0), (self.qtgui_time_sink_x_0_1_1, 0))
